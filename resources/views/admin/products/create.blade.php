  ...
  @section('content')
  <div class="page-wrapper-row full-height services" xmlns="http://www.w3.org/1999/html">
  ...
  <div class="portlet-title">
    <div class="caption">
        ...
        <span class="caption-subject font-green-haze bold uppercase">Add Product</span>
    </div>
  ...
  <div class="portlet-body form">
    ...
    <!-- BEGIN FORM-->
    <form method="post" action="{{ url('admin/products/store') }}" id="tagsinput" enctype="multipart/form-data">
                    ...
                    <div class="content_for">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" data-role="tagsinput" id="colors" name="colors" value="{{ old('colors') }}" class="form-control" placeholder="Enter Colors">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="available" class="form-control">
                                    ...
                                    <option selected {{ old('available') == '1' ? 'selected' : '' }} value="1">Yes</option>
                                    <option {{ old('available') == '0' ? 'selected' : '' }} value="0">No</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="discount" step="any" name="discount" value="0" class="form-control" placeholder="Enter Discount">
                                 </div>
                             </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" id="price_discount" readonly name="price_discount" value="{{ 0 or old('price_discount') }}" class="form-control" placeholder="Enter Price Discount">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" style="height: 200px" class="form-control" placeholder="Enter Description">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
